...
class __TwigTemplate_c132d7398c32ce01b4cff520f5682d44 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div";
    ...
    <div id=\"home-body_front\">
      <div class=\"home-body_image\">
        <img
          src=\"https://i0.wp.com/thepresentwriter.com/wp-content/uploads/2020/08/HomePage-Picture_thepresentwriter.png?resize=1024%2C405&ssl=1\"
          alt=\"\">
      </div>
      <div class=\"home-body_content container\">
        <div class=\"row align-items-start\">
          ...
          <div class=\"home-body_avatar col-12 col-md-3\">
            <img src=\"https://i0.wp.com/thepresentwriter.com/wp-content/uploads/2020/08/About-image.png?w=800&ssl=1\"
              alt=\"\">
          </div>
          <div class=\"home-body_description col-12 col-md-9\">
            <h2>Xin chào</h2>
            <p>
              Cảm ơn bạn đã ghé thăm website <span>The Present Writer</span>. Đây là một “khu vườn xanh yên tĩnh”—theo
              cách gọi của nhiều người yêu The Present Writer—là nơi để bạn nghỉ ngơi, suy ngẫm và lắng nghe tâm hồn
              mình sau những ồn ào, mệt mỏi của thế giới bên ngoài.

              The Present Writer bắt đầu là một Blog cá nhân từ năm 2016 và dần được phát triển thêm thành kênh Youtube
              và Podcast về bài học cuộc sống, phát triển bản thân và Chủ nghĩa tối giản.

              The Present Writer được sáng tạo bởi Chi Nguyễn—Tiến sĩ Giáo dục tại Mỹ, blogger, và tác giả “Một Cuốn
              Sách Về Chủ Nghĩa Tối Giản”. Đọc thêm về Chi và The Present Writer tại đây
            </p>
          </div>
        </div>
      </div>
    ...
    {
        return new Source("", "themes/custom/sweetscented/templates/node--1.html.twig", "C:\\xampp\\htdocs\\code\\SweetScented\\themes\\custom\\sweetscented\\templates\\node--1.html.twig");
    }
