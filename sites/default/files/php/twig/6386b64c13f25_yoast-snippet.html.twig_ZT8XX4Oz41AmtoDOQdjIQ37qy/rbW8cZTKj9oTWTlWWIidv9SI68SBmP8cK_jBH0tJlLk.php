...
class __TwigTemplate_17a1037e38df3b274b6147c5c709b927c6f6cbc0fcb4ffd1f315249011e27107 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div id=\"wpseo_meta\"></div>
    <div class=\"label\">{% trans %}Snippet preview{% endtrans %}</div>
    <div id=\"{{ snippet_target_id }}\"></div>
    <div class=\"label\">{% trans %}Content analysis{% endtrans %}</div>
    <div id=\"{{ output_target_id }}\"></div>
</div>
", "modules/contrib/yoast_seo/templates/yoast-snippet.html.twig", "/app/modules/contrib/yoast_seo/templates/yoast-snippet.html.twig");
    }
