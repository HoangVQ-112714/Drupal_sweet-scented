...
class __TwigTemplate_294755a2ede6768209b2be3417a006b6 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 81, $this->source)))) : (""))];
  ...
  <div";
    ...
    {
        return new Source("", "themes/custom/sweetscented/templates/node--blog--full.html.twig", "C:\\xampp\\htdocs\\code\\SweetScented\\themes\\custom\\sweetscented\\templates\\node--blog--full.html.twig");
    }
